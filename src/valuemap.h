...
// Directly wrapped calls
	map_t::const_iterator find(const std::string& name) const {	return map.find(name); } 
	map_t::const_iterator begin() const {	return map.cbegin(); }
	map_t::const_iterator end() const {	return map.cend(); }
